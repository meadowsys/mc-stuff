...
| Cloth Config             | client               | Provides configuration screen API for other mods                                                      | unknown   | [yes (6.1)][Cloth Config:build-1.18]            | [curseforge][Cloth Config:curseforge]                                                                   | [github][Cloth Config:repo]             |
| Colormatic               | client               | implements MCPatcher custom colors mod, compatible with Optifine custom colors                        | yes       | [yes (2.4.0)][Colormatic:build-1.18]            | [github][Colormatic:github], [modrinth][Colormatic:modrinth]                                            | [github][Colormatic:repo]               |
| Continuity               | client               | implements connected textures, aims to be fully compatible with MCPatcher/Optifine connected textures | unknown   | [yes (1.0.3)][Continuity:build-1.18]            | [curseforge][Continuity:curseforge]                                                                     | [github][Continuity:repo]               |
| Dynamic FPS              | client               | Limits Minecraft resource usage when running in the background                                        | unknown   | yes                                             | [curseforge][Dynamic FPS:curseforge]                                                                    | [github][Dynamic FPS:repo]              |
| Entity Culling           | client               | Uses async path tracing to skip rendering entities you can't see                                      | unknown   | yes                                             | [curseforge][Entity Culling:curseforge]                                                                 | [github][Entity Culling:repo]           |
| Fabric API               | client and/or server | library mod                                                                                           | yes       | [yes (0.44.0)][Fabric API:build-1.18]           | [github][Fabric API:github], [modrinth][Fabric API:modrinth]                                            | [github][Fabric API:repo]               |
| fabrishot                | client               | take high-resolution screenshots                                                                      | yes       | yes(?)                                          | [modrinth][fabrishot:modrinth]                                                                          | [github][fabrishot:repo]                |
| HDSkins                  | client               | high resolution skins                                                                                 | yes       | [yes (6.5.1)][HDSkins:build-1.18]               | [github][HDSkins:github], [website][HDSkins:website]                                                    | [github][HDSkins:repo]                  |
| Hydrogen                 | client and/or server | things of which are too "dirty" to put in Lithium                                                     | yes       | no                                              | [github][Hydrogen:github]                                                                               | [github][Hydrogen:repo]                 |
| Indium                   | client               | addon for Sodium that implements Fabric Rendering API (does nothing on its own)                       | yes       | unstable(?)                                     | [github][Indium:github], [modrinth][Indium:modrinth]                                                    | [github][Indium:repo]                   |
| LambDynamicLights        | client               | dynamic lights mod                                                                                    | yes       | [yes (2.1.0)][LambDynamicLights:build-1.18]     | [github][LambDynamicLights:github]                                                                      | [github][LambDynamicLights:repo]        |
| Litematica               | client               | schematic mod                                                                                         | yes       | no                                              | [curseforge][Litematica:curseforge]                                                                     | [github][Litematica:repo]               |
| Lithium                  | client and/or server | general performance optimisation mod that is designed to not break things                             | yes       | no                                              | [github][Lithium:github], [modrinth][Lithium:modrinth]                                                  | [github][Lithium:repo]                  |
| malilib                  | client and/or server | library mod                                                                                           | yes       | [yes (0.10.0-dev.26)][malilib:build-1.18]       | [curseforge][malilib:curseforge]                                                                        | [github][malilib:repo]                  |
...
| Sound Physics Remastered | client               | Provides realistic sound attenuation, reverbation, and absorption through blocks                      | unknown   | yes                                             | [curseforge][Sound Physics Remastered:curseforge]                                                       | [github][Sound Physics Remastered:repo] |
| TellMe                   | client and/or server | small informational mod, provides technical type information about the game                           | yes       | no                                              | [curseforge][TellMe:curseforge]                                                                         | [github][TellMe:repo]                   |
| Tweakeroo                | client               | adds a selection of miscellaneous, configurable, client-side tweaks to the game                       | yes       | no                                              | [curseforge][Tweakeroo:curseforge]                                                                      | [github][Tweakeroo:repo]                |
| Void Fog                 | client               | brings back the void fog                                                                              | yes       | [yes (2.6.1)][Void Fog:build-1.18]              | [github][Void Fog:github]                                                                               | [github][Void Fog:repo]                 |
...
| pack name        | description                                                                                        | MC 1.17.1 | MC 1.18.1  | official download link            | repo link                       |
| ---------------- | -------------------------------------------------------------------------------------------------- | --------- | ---------- | --------------------------------- | ------------------------------- |
| Love & Tolerance | resource pack inspired by the visual art style and design of _My Little Pony: Friendship is Magic_ | yes       | partial(?) | [github][Love & Tolerance:github] | [github][Love & Tolerance:repo] |
| turtlelang       | provides a ingame language called turtlelang, explore at your own risk!                            | partial   | partial(?) | [github][turtlelang:github]       | [github][turtlelang:repo]       |
...
[Cloth Config:build-1.18]: mods/1.18/1.18-cloth-config-6.1.jar
...
[Colormatic:build-1.18]: mods/1.18/1.18-colormatic-2.4.0.jar

[Continuity:repo]: https://github.com/PepperCode1/Continuity
[Continuity:curseforge]: https://www.curseforge.com/minecraft/mc-mods/continuity/files
[Continuity:build-1.18]: mods/1.18/1.18-continuity-1.0.3.jar

[Dynamic FPS:repo]: https://github.com/juliand665/Dynamic-FPS
[Dynamic FPS:curseforge]: https://www.curseforge.com/minecraft/mc-mods/dynamic-fps

[Entity Culling:repo]: https://github.com/tr7zw/EntityCulling
[Entity Culling:curseforge]: https://www.curseforge.com/minecraft/mc-mods/entityculling/files
...
[Sound Physics Remastered:repo]: https://github.com/henkelmax/sound-physics-remastered
