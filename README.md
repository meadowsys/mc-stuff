...
| Cloth Config             | client               | Provides configuration screen API for other mods                                                      | unknown   | unknown   | [yes (6.1)][Cloth Config:build-1.18]            | [curseforge][Cloth Config:curseforge]                                                                   | [github][Cloth Config:repo]             |
| Colormatic               | client               | implements MCPatcher custom colors mod, compatible with Optifine custom colors                        | yes       | yes       | [yes (2.4.0)][Colormatic:build-1.18]            | [github][Colormatic:github], [modrinth][Colormatic:modrinth]                                            | [github][Colormatic:repo]               |
| Continuity               | client               | implements connected textures, aims to be fully compatible with MCPatcher/Optifine connected textures | unknown   | unknown   | [yes (1.0.3)][Continuity:build-1.18]            | [curseforge][Continuity:curseforge]                                                                     | [github][Continuity:repo]               |
| Dynamic FPS              | client               | Limits Minecraft resource usage when running in the background                                        | unknown   | unknown   | yes                                             | [curseforge][Dynamic FPS:curseforge]                                                                    | [github][Dynamic FPS:repo]              |
| Entity Culling           | client               | Uses async path tracing to skip rendering entities you can't see                                      | unknown   | unknown   | yes                                             | [curseforge][Entity Culling:curseforge]                                                                 | [github][Entity Culling:repo]           |
...
| Sound Physics Remastered | client               | Provides realistic sound attenuation, reverbation, and absorption through blocks                      | unknown   | unknown   | yes                                             | [curseforge][Sound Physics Remastered:curseforge]                                                       | [github][Sound Physics Remastered:repo] |
